...
const ng_module_utils_1 = require("ask-schematics-generator/src/utils/ng-module-utils");
const ng_module_utils_2 = require("ask-schematics-generator/src/utils/ng-module-utils");
const find_module_1 = require("ask-schematics-generator/src/schematics-angular-utils/find-module");
const add_injection_1 = require("ask-schematics-generator/src/utils/add-injection");
const config_1 = require("ask-schematics-generator/src/schematics-angular-utils/config");
const parse_name_1 = require("ask-schematics-generator/src/utils/parse-name");
...
function default_1(options) {
  return (host, context) => {
    ...
    let newCop = {
      ...options,
      name: `new-${parsedPath.name}`,
      path: `${parsedPath.path}/${parsedPath.name}`,
    };

    const rule = schematics_1.chain([
      schematics_2.branchAndMerge(
        schematics_1.chain([
          ...
          ng_module_utils_2.addDeclarationToNgModule(
            newCop,
            newCop.export,
            true
          ),
