...
import { MenuOptions } from 'nav/src/ask/schema';
import { apply, filter, move, Rule, template, url, branchAndMerge, Tree, SchematicContext } from '@angular-devkit/schematics';
import { strings } from '@angular-devkit/core';
import { addDeclarationToNgModule } from 'nav/src/utils/ng-module-utils';
import { findModuleFromOptions } from 'nav/src/schematics-angular-utils/find-module';
import { injectServiceIntoAppComponent } from 'nav/src/utils/add-injection';

import { getWorkspace } from 'nav/src/schematics-angular-utils/config';
import { parseName } from 'nav/src/utils/parse-name';
